<template>
    <div class="top"><span>To: <span class="name">{{ group.name }}</span></span></div>
            <div class="chat" :data-chat="'person'+group.id">
                ...
                <div class="bubble you" v-for="conversation in conversations">
            ...
            <div class="write">
                ...
                <input type="text" placeholder="Type your message here..." v-model="message" @keyup.enter="store()" autofocus/>
                <a href="javascript:;" class="write-link smiley"></a>
                <a href="javascript:;" class="write-link send" @click.prevent="store()"></a>
            </div>
